  ...
  useEffect(() => {
    async function fetchPosts() {
      try {
        ...
        // Filter out posts that have the "Projects" category
        const nonProjectPosts = posts.filter(post =>
          !post.categories?.some(cat => cat.toLowerCase() === 'projects')
        );
        setAllPosts(nonProjectPosts);
        setFilteredPosts(nonProjectPosts);
      } catch (error) {
        ...
        <div className={`container`}>
          <div className={styles.sectionHeader}>
            <div className={styles.headingWrapper}>
              ...
              <h2 className="heading-lg">Blog Posts</h2>
            </div>
